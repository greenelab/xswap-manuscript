...
![
  ...
  **B.** Proposed extensions to the XSwap algorithm.
...
For bipartite networks, each node's number of connections to the other part is preserved, and overall node class memberships are preserved.
