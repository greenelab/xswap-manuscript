...
![**A.** Degree distributions of networks with and without degree bias can be very different.
  ...
  **C.** Node degree in a literature-derived network is not linearly correlated with degree in a systematically-derived network.
  ...
  Edges found in literature-derived networks represent a non-random sample from systematically-derived edges.](https://github.com/zietzm/xswap-analysis/raw/fb5e093ab5baedd129629ee8e41526c286cbbe45/img/fig1.degree_bias.png){#fig:degree-bias width="100%"}
...
All five features show a positive relationship with degree, though the magnitude of this correlation is highly variable.](https://github.com/greenelab/xswap-analysis/raw/fb5e093ab5baedd129629ee8e41526c286cbbe45/img/fig2.feature_degree.png){#fig:features-degree width="100%"}
...
![
  ...
  **B.** Sampling network edges generally reduces performance of reconstructing the unsampled network.](https://github.com/zietzm/xswap-analysis/raw/fb5e093ab5baedd129629ee8e41526c286cbbe45/img/fig3.combined_auroc.png){#fig:all_auroc width="85%"}
