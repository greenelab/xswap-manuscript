...
Our software is designed to capture predictive performance attributable to degree to provide a baseline expectation for edge pairs.
...
We develop software that quantifies the edge probability due to degree.
...
Ordering these scores provides an assessment of performance based solely on degrees and edge distributions, which can be used as a baseline for other classifiers.
