...
For PPI and TF-TG data, the two networks are one produced via unbiased experimentation and one based on relationships found in the literature.
...
![**A.** Degree distributions of networks with and without degree bias can be very different.
  ...
  **C.** Node degree in a literature-derived network is not linearly correlated with degree in a systematically-derived network.
  ...
  Edges found in literature-derived networks represent a non-random sample from systematically-derived edges.](https://github.com/zietzm/xswap-analysis/raw/181a28ae3bd4422f3dbb24897b7cef35887f9658/img/1_degree_bias/combined.png){#fig:degree-bias width="100%"}
...
All five features show a positive relationship with degree, though the magnitude of this correlation is highly variable.](https://github.com/greenelab/xswap-analysis/raw/181a28ae3bd4422f3dbb24897b7cef35887f9658/img/2_link_prediction_feature_degree_correlation/without_prior.png){#fig:features-degree width="100%"}
...
Therefore, it is important to have a more general method for comparing the effects of node degree on link prediction methods and the tasks themselves.
...
Network randomization using the XSwap algorithm preserves only the network's degree sequence.
...
We performed three prediction tasks to assess the performance of the edge prior, and we compared two additional features, a scaled product of source and target degree (scaled to the range [0, 1]), and the closed-form approximation of the edge prior.
...
![
  ...
  **B.** Sampling network edges generally reduces performance of reconstructing the unsampled network.](https://github.com/zietzm/xswap-analysis/raw/181a28ae3bd4422f3dbb24897b7cef35887f9658/img/combined_auroc.png){#fig:all_auroc width="85%"}
...
![
  ...
  **D.** Boxplots summarizing individual Hetionet network calibrations](https://github.com/zietzm/xswap-analysis/raw/181a28ae3bd4422f3dbb24897b7cef35887f9658/img/calibration_combined.png){#fig:cal width="100%"}
...
We find that the three features have similar calibrations in the second task as they had in the first.
