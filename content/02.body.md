...
For the a network reconstruction task without holdout, we expected features based on degree to show strong performance, as found in our first prediction task.
