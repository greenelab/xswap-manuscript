...
![**A.** Degree distributions of networks with and without degree bias can be very different.
  ...
  **C.** Node degree in a literature-derived network is not linearly correlated with degree in a systematically-derived network.
  ...
  Edges found in literature-derived networks represent a non-random sample from systematically-derived edges.](https://github.com/zietzm/xswap-analysis/raw/1c4e5834125c66e6f3ae924db30ed1b56d20a45c/img/1_degree_bias/combined.png){#fig:degree-bias width="100%"}
...
All five features show a positive relationship with degree, though the magnitude of this correlation is highly variable.](https://github.com/greenelab/xswap-analysis/raw/bd40eb244ffe37454dc08099f5742ef3e962c70d/img/2_link_prediction_feature_degree_correlation/without_prior.png){#fig:features-degree width="100%"}
...
We performed three prediction tasks to assess the performance of the edge prior, and we compared two additional features, a scaled product of source and target degree, and the closed-form approximation of the edge prior.
...
![
  ...
  **B.** Sampling network edges generally reduces performance of reconstructing the unsampled network.](https://github.com/zietzm/xswap-analysis/raw/b5da3ea54ab694f58cc724e0339900110cff012f/img/combined_auroc.png){#fig:all_auroc width="85%"}
...
![
  ...
  **D.** Boxplots summarizing individual Hetionet network calibrations](https://github.com/zietzm/xswap-analysis/raw/b5da3ea54ab694f58cc724e0339900110cff012f/img/calibration_combined.png){#fig:cal width="100%"}
