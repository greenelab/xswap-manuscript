...
![**A.** The edge prior shows superior calibration to the other two features.
  Calibration curves for full network reconstruction of 20 networks from Hetionet.
  **B.** Calibration curves for sampled network reconstruction. The edge prior shows superior calibration in the 20 Hetionet networks.
