...
Model evaluation is challenging in this context: nonspecific or trivial predictions can be correct, even if they are not the desired outputs of the predictive model, and dominate performance evaluations.
...
Our permutation framework is measures the predictive performance attributable to degree to provide a baseline expectation for edge pairs.
